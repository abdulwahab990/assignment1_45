...
const currentUsers:string [] = ["StellarGazer92", "MidnightJazz", "ElectricEchoes", "QuantumQuirk", "SereneBreeze"];

// array of new users
const newUsers:string [] = ["StellarGazer92","EnigmaWhisper", "NebulaNomad", "QuantumQuirk", "AuroraScribe"];

...
const favoutiteAnimal:string[] = ["Dolphin", "Elephant", "Bat"]

// print the name of animal with for loop

for(let i = 0; i < favoutiteAnimal.length; i++){
    console.log(favoutiteAnimal[i])
}

// lines for every mammal
for(let i = 0; i < favoutiteAnimal.length; i++){
    console.log(`The ${favoutiteAnimal[i]} is Mammal`)
}

// common about these animals
console.log("\nThese all animals are mammals")
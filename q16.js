...
const guestWhoCantMakeItTo = "Guest 3";
// New person to invite
const newInvitees = "New Guest";
// Additional guests to invite
const newGuest1 = "Additional Guest 1";
const newGuest2 = "Additional Guest 2";
const newGuest3 = "Additional Guest 3";
// Find the index of the guest who can't make it
const indexOfGuestWhoCantMakeIt = guestlist.indexOf(guestWhoCantMakeItTo);

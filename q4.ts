...
new.”
5. Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s na
*/

let prophetName:string = "Prophet Muhammad";
console.log(`${prophetName}once said, ${ "A believer should not be stung twice from the same hole."}`);